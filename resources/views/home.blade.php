...
<html >
    ...
    <body class="background"> 
        <div class="video_page_size video_page_small_size" >
            <div class="div div_size div_flex_row_center"> 
                <div class="video_page_scroll" style="height:100%;width:95%">
                    <?php
                        $video_data_json_path=base_path("app/Models/jsons/video_data.json");
                        $video_data_json=json_decode(file_get_contents($video_data_json_path),true);
                        foreach($video_data_json as $json){
                            print("<a href=\"/video/".$json['video_name']."\">".
                                    "<div class=\"div video_item_flex margin_5\" style=\"width:95%;height:100px\">".
                                        "<div class=\"margin_5\">".
                                            "<b class=\"text_color\" style=\"font-size:20px\">".
                                                $json['video_name'].
                                            "</b>".
                                        "</div>".
                                        "<div class=\"margin_5\">".
